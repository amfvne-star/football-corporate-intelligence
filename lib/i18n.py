...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "rq.caption": {
        "en": "Descriptive results from notebook section 17. These findings do not imply causality — see limitations at the bottom of the page.",
        "pt": "Resultados descritivos da secção 17 do notebook. Estes resultados não implicam causalidade — ver limitações no final da página.",
    },
    "rq.empty": {
        "en": "This page stays empty until you copy the `resultados/` folder (produced by notebook section 17) into the project root.",
        "pt": "Esta página fica vazia até copiares a pasta `resultados/` (produzida pela secção 17 do notebook) para a raiz do projeto.",
    },
    "rq.filters_note": {
        "en": "These are precomputed results (notebook section 17) — the sidebar filters used on other pages do not apply here.",
        "pt": "Estes são resultados pré-calculados (secção 17 do notebook) — os filtros da barra lateral usados noutras páginas não se aplicam aqui.",
    },
    ...
    "rq.q1_header": {
        "en": "Q1 · How many financing events per club, and across which sub-types?",
    ...
    "rq.q2_header": {
        "en": "Q2 · How does financing activity cluster over time?",
        "pt": "Q2 · Como se agrupa a atividade de financiamento ao longo do tempo?",
    },
    "rq.q2_body": {
    ...
    "rq.q2_caption": {
        "en": "The years/periods with the highest spikes are annotated automatically below (mean + one standard deviation) — read them against known transfer windows, seasons, and macroeconomic events (2008 crisis, COVID-19) rather than as proof of causation.",
        "pt": "Os anos/períodos com os maiores picos são assinalados automaticamente abaixo (média + um desvio-padrão) — interpreta-os à luz de janelas de transferências, épocas e eventos macroeconómicos conhecidos (crise de 2008, COVID-19), e não como prova de causalidade.",
    },
    "rq.q3_header": {
        "en": "Q3 · How much does archival coverage vary by club?",
        "pt": "Q3 · Quanto varia a cobertura arquivística entre clubes?",
    },
    "rq.q3_body": {
        "en": "Is one club simply better covered by the archived press than another, which would bias any direct comparison?",
        "pt": "Será que um clube está simplesmente mais bem coberto pela imprensa arquivada do que outro, o que enviesaria qualquer comparação direta?",
    },
    ...
    "rq.annotation_2008": {"en": "2008 crisis", "pt": "Crise de 2008"},
